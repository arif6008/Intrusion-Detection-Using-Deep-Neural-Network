# -*- coding: utf-8 -*-
"""
Created on Sat Apr 27 16:51:30 2019
...
X_test=feature_test.reshape((69796, 1, 38, 1))
...
cnn.fit(X, Y, nb_epoch=5,batch_size=500,verbose=2)

score = cnn.evaluate(X_test, Y_test, batch_size=300)
(loss, accuracy)=score
